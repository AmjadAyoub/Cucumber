...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_clicks_on_pim_option() {
     //   WebElement pimOption = driver.findElement(By.id("menu_pim_viewPimModule")); // this row and next comment out same as in loginSteps class
      //  pimOption.click();
    ...
    public void user_enter_firstname_and_lastname() {
     //   WebElement firstName = driver.findElement(By.id("firstName"));
      //  firstName.sendKeys("Amjad");

        sendText(addEmployee.firstNameField, "Amjad");
        sendText(addEmployee.lastNameField, "Ayoub");
