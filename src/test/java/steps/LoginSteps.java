...
public class LoginSteps extends CommonMethods {
  ...
  //  WebDriver driver;
    ...
    public void user_enters_valid_username_and_valid_password() {
      //  LoginPage login = new LoginPage();  we comment out this row in this class because it is created in PageInitializer class and extends in Common methods
        //   WebElement usernameField = driver.findElement(By.id("txtUsername"));
        // usernameField.sendKeys(ConfigReader.getPropertyValue("username"));
        sendText(login.usernameTextField, ConfiqReader.getPropertyValue("username"));
        //  WebElement passwordField = driver.findElement(By.id("txtPassword"));
        //    passwordField.sendKeys(ConfigReader.getPropertyValue("password"));
        sendText(login.passwordTextField, ConfiqReader.getPropertyValue("password"));
    }


    @When("user clicks on login button")
    public void user_clicks_on_login_button() {
     //   LoginPage login = new LoginPage(); see above why comment out
    ...
    public void user_is_successfully_logged_in() {
     //   WebElement welcomeMessage = driver.findElement(By.id("welcome"));
       // System.out.println(10/0); //we added this row to fail the test and create failed file with screenshot
